...
private const val PATH_TO_MODEL = "savedmodels/lenet5SavedModel"
...
fun main() {
    ...
    lenet5.use {
        ...
        it.save(File(PATH_TO_MODEL), savingFormat = SavingFormat.TF_SAVED_MODEL, writingMode = WritingMode.OVERRIDE)
