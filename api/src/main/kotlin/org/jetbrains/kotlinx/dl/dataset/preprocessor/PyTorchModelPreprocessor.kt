 ...
 */
public class PyTorchModelPreprocessor(public var pyTorchModel: PyTorchModel?) : Preprocessor {
    override fun apply(data: FloatArray, inputShape: ImageShape): FloatArray {
        ...
        // TODO: we need swapaxis again in reality, but maybe it will be enough good without it
        return pyTorchModel!!.rawPredict(data)
    }
}
